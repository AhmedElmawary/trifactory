...
function onFileChange(){
    if ($('#national_id_image').val()) {
        ...
        if (document.getElementById("national_id_image") != null && document.getElementById("national_id_image").files[0] && document.getElementById("national_id_image").files[0].size > 26214400) {   //25MB
