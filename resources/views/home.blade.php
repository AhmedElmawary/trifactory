...
<!-- Start Content -->
<section class="hero-section d-flex justify-content-center no-padding">
...
<section class="events-section container @if($upcomingEvents->count() === 0) vouchers-section @endif">
...
<section class="results-section container no-height">
    <h3 class="section-title">
        <img src="images/results-icon.svg" alt="results-icon" class="icon" />Leaderboard
    </h3>
    {{-- {{var_dump($years)}} --}}
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-lg-12 table-responsive-lg">
            <table id="maleBody" class="table table-striped table-bordered">
                ...
                @else
                <tr align='center'>
                    <td>No Data found for Year: {{(session()->get("year")?$years[0]:"")}}</td>
                </tr>
                @endif
            </table>
        </div>
    ...
    <div class="row">
        <div id="viewMoreMale" class="col-lg-12 results-head">
            <a id="rankMalesUrl" href="/leaderboard/{{session()->get("year",$years[0])}}#pills-rankings-male" class="bbtn dark btn-clear float-right mt-2">@if (count($leaderboardMale)) View More @endif</a>
    ...
    <div class="row">
        <div id="viewMoreFemale" class="col-lg-12 results-head">
            <a id="rankFemalesUrl" href="/leaderboard/{{session()->get("year",$years[0])}}#pills-rankings-female" class="bbtn dark btn-clear float-right mt-2"> @if (count($leaderboardFemale)) View More @endif</a>
        </div>
    </div>
    ...
    <div class="row">
        <div id="viewMoreClub" class="col-lg-12 results-head">
            <a id="rankClubUrl" href="/leaderboard/{{session()->get("year",$years[0])}}#pills-rankings-club" class="bbtn dark btn-clear float-right mt-2">@if (count($leaderboardClub)) View More @endif</a>
        </div>
    </div>
</section>
