...
<section class="container no-height no-separator">
  <h3 class="section-title">
    <img src="/images/tickets-icon.svg" alt="tickets-icon" class="icon">Order @if($order->success === 'true') Successful @else Failed @endif
  </h3>
  ...
  <div class="row cart-summary-container col-lg-6">
    ...
    <div class="cart-summary-item separator">
      Order Status: <span class="float-right">@if($order->success === 'true') Successful @else Failed @endif</span>
    </div>
